...
class CrossSaleOfferRequest extends AbstractRequest
{
    ...
    /**
     * @return \Shift4\Request\CrossSaleOfferRequestCharge
     */
    public function getCharge()
    {
        return $this->getObject('charge', '\Shift4\Request\CrossSaleOfferRequestCharge');
    }
    ...
    /**
     * @return \Shift4\Request\CrossSaleOfferRequestSubscription
     */
    public function getSubscription()
    {
        return $this->getObject('subscription', '\Shift4\Request\CrossSaleOfferRequestSubscription');
    }
